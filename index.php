...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+234 1234567890</li>	
					<li class="s-bar">
						<div class="search">
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							<span class="cbpy-icon w3_road"></span>
...
<!-- /contact -->
			<div class="copy">
		        <p>© <span id=year></span>  SUNRISE . All Rights Reserved | Design by <a href="index.php">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
<script>
